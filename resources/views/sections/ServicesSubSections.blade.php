                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            <tbody>
                                <?php $i = 0; ?>
                                @foreach ($ServicesSubSections as $ServicesSubSection)
                                    <?php $i++; ?>
                                    <tr>
                                        <td>{{ $i }}</td>
                                         <td>{{ $ServicesSubSection->name }}</td>  
                                        <td>{{ $ServicesSubSection->section->name }}</td>
                                        <td>{{ $ServicesSubSection->description }}</td>
                                        <td>
                                            <button class="btn btn-outline-success btn-sm"
                                                        data-service_name="{{ $ServicesSubSection->name }}"
                                                        data-service_id="{{ $ServicesSubSection->id }}"
                                                        data-section_name="{{ $ServicesSubSection->section->name }}"
                                                        data-description="{{ $ServicesSubSection->description }}"
                                                        data-toggle="modal"
                                                        data-target="#edit_service">تعديل
                                            </button>
                                            <button class="btn btn-outline-danger btn-sm "
                                                data-service_id="{{ $ServicesSubSection->id }}"
                                                data-service_name="{{ $ServicesSubSection->name }}" data-toggle="modal"
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('services.store', ['id'])}}" method="post" autocomplete="off">
                            {{ csrf_field() }}
            ...
            <div class="modal fade" id="edit_service" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{route('services.update', ['id'])}}" method="post" autocomplete="off">
                            {{ method_field('patch') }}
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
